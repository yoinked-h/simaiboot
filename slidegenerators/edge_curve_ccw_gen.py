...
class EdgeCurveCCWGen(SlideGenerator):
    ...
    def __init__(self, verts: list[Location]):
        ...
        start_delta = trig.get_tangent_angle_delta(self.CurveRadius, magnitude, False)
        ...
        end_delta = trig.get_tangent_angle_delta(self.CurveRadius, end_magnitude, True)
        ...
        self.curve_len = trig.get_angle_span(self.tangent_in_rot, tangent_out_rot, False, trig.TAU / 4) * self.CurveRadius
